...
public class RegisterPatient extends AppCompatActivity {
    ...
    public void onBackPressed() {
        final AlertDialog alertDialog = new AlertDialog.Builder(RegisterPatient.this).create();
    ...
    private void userTypePopUp() {
        final Intent intentD = new Intent(RegisterPatient.this, RegisterDoctor.class);
        final Intent intentP = new Intent(RegisterPatient.this, RegisterPatient.class);
        final AlertDialog alertDialog = new AlertDialog.Builder(RegisterPatient.this).create();
        ...
        address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Autocomplete.IntentBuilder(AutocompleteActivityMode.OVERLAY,
                        fieldList).build(RegisterPatient.this);
...
/*        login.setOnClickListener(new View.OnClickListener() {
        ...
        change = (TextView) findViewById(R.id.changeP);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user.equals("")) {
                    ...
                    final ProgressDialog pd = new ProgressDialog(RegisterPatient.this);
                            ...
                            if (s.equals("null")) {
                                ...
                                try {
                                    ...
                                    if (!obj.has(user)) {
                                        ...
                                        reference.child(user).child("password").setValue(pass);
                                        reference.child(user).child("type").setValue("Patient");
                                        reference.child(user).child("speciality").setValue("NA");
                                        ...
                                        reference.child(user).child("address").child("longitude")
                                                .setValue(longitude);
                                        Toast.makeText(RegisterPatient.this, "Registration successful, please login now!", Toast.LENGTH_LONG).show();
                                        finish();
                                    } else {
                                        Toast.makeText(RegisterPatient.this, "Username already exists", Toast.LENGTH_LONG).show();
                                    }
                    ...
                    RequestQueue rQueue = Volley.newRequestQueue(RegisterPatient.this);
                    rQueue.add(request);
                }
            }
        });*/
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if(!ConnectivityStatus.isConnected(getApplicationContext())){
                ...
                // no connection
                Snackbar snackbar = Snackbar.make(username, "Looks like you do not have network. Either enable Wi-Fi or mobile data!", Snackbar.LENGTH_LONG).setAction("Action", null);
